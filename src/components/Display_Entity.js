...
class Display_Entity extends Component {
    ...
    componentDidMount(){
        const url=`http://localhost:8001/${this.props.match.params.id}`;
        fetch(url, {
            method:"GET"
        ...
        fetch(`http://localhost:8002/${this.props.match.params.id}`)
    ...
    render(props) {
        ...
        return (
            <div >
                <Wrapper1><Title>Data Lineage - Entity Description</Title></Wrapper1>
                ...
                <Grid container spacing={5}>
                    <Grid item xs={5}>
                        ...
                        <h4 align="center">Number of Application Consuming this Entity : {this.state.num}</h4>
                        </Paper>
                    </Grid>
                    <Grid item xs={7} >
